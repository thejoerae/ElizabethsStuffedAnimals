...
class ViewToyFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.view_toy_fragment, container, false)
        ...
        for (i in 0 until data.size) {
            ...
            tv3.text = data[i].name.toString()

            // Add extras textview
            val tv4 = TextView(view.context)
            tv4.text = data[i].color.toString()

            // Add quanity textview
            val tv5 = TextView(view.context)
            tv5.text = data[i].notes.toString()
